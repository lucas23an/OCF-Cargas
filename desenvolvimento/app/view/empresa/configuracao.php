                                ...
                                <fieldset class="forms-spaces">
                                    ...
                                    <div class="row">
                                      <div class="col-xs-12 col-md-4 form-group">
                                        ...
                                        <input type="text" name="nome" class="form-control" value="Lorem Ipsum">
                                      </div>
                                      <div class="col-xs-12 col-md-4 form-group">
                                      ...
                                      <div class="col-xs-12 col-md-4 form-group">
                                        ...
                                        <input type="email" name="email" class="form-control" value="loremipsum@lorem.com">
                                      </div>
                                    </div>
                                      <div class="row form-group">
                                        <div class="col-lg-6 ">
                                            <label>CNPJ</label>
                                            <input type="text" name="cnpj" class="form-control" value="999.999.999-99">
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Razão Social</label>
                                            <input type="text" name="razaosocial" class="form-control" value="Lorem Ipsum">
                                        </div>
                                      </div>
                                      ...
                                      <div class="row form-group">
                                        <div class="col-lg-3">
                                            <label>CEP</label>
                                            <input type="text" name="cep" class="form-control" value="75000-000">
                                        </div>
                                        <div class="col-lg-2">
                                            <label>UF</label>
                                        ...
                                        <div class="col-lg-3">
                                            <label>Setor</label>
                                            <input type="text" name="setor" class="form-control" value="Lorem Ipsum">
                                        </div>
                                        <div class="col-lg-1">
                                            <label>Nº</label>
                                            <input type="text" name="numero" class="form-control" value="2">
                                        </div>
                                      </div>
                                      ...
                                      <div class="row form-group">
                                        <div class="col-lg-5">
                                            ...
                                            <input type="text" name="complemento" class="form-control" value="Lorem Ipsum">
                                        </div>
                                        <div class="col-lg-4">
                                            <label>Fone</label>
                                  ...
                                  <form class="" action="index.html" method="post">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <table class="table"><tr>
                                                <td><input type="radio" name="cnpjbusca" name="busca"> CNPJ</td>
                                                <td><input type="radio" name="razaobusca" name="busca"> Rasão Social</td>
                                            </tr></table>
                                    </div>
